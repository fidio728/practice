...
# ============================================================
const REVERE_PRESENCE_RULE = get(ENV, "DPN_REVERE_PRESENCE_RULE", "record_interval")
...
""")
CSV.write(joinpath(OUT_DIR, "02_revere_coverage_start_hist.csv"), entry_hist)
...
println(s1_s3)
CSV.write(joinpath(OUT_DIR, "02_revere_coverage_start_vs_firstlink.csv"), s1_s3)
...
println(cov_prof)
CSV.write(joinpath(OUT_DIR, "02_revere_covered_flag_profile.csv"), cov_prof)
...
CSV.write(joinpath(OUT_DIR, "02_em_zero_recode_census.csv"), recode_census)
...
if isfile(preem_path)
    ...
    println(gate)
    CSV.write(joinpath(OUT_DIR, "02_em_p0_gate_vs_preEM.csv"), gate)
...
println(pct)
CSV.write(joinpath(OUT_DIR, "02_china_exposure_percentiles_snapshot.csv"), pct)
