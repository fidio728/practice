...
| F1/F3 randomization-inference p | headline 0.62, lead 0.92, LP h1 0.47, h4 0.23 | `run_randomization_inference.py` | `audit_c6_panel.parquet` → `audit_randomization_inference.csv` |
